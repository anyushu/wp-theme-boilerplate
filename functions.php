...
add_action('wp_head', 'custom_wp_head_remove_action');
...
add_action('template_redirect', 'custom_template_redirect_remove_action');
...
add_action('wp_print_styles', 'custom_wp_print_styles_remove_action');
